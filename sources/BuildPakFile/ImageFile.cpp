...
#include "ImageFile.h"		// Classes d'Images de tout format
...
TStdImage* TImageLoader::LoadAnyImage(ifstream *fp)
...
TStdImage* TImageLoader::LoadImageBmp(ifstream *fp)
{	TStdImage*	image = NULL;
	int cur = fp->tellg();
