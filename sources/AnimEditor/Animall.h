...
#define ANIM_ACTION_LAST_NUM 	    18

// Intervalle ds lequel se trouvent lesanims superposables classiques
#define ANIM_SUPERPOSEE_FIRST_NUM 1000 
#define ANIM_SUPERPOSEE_LAST_NUM  9998
...
class AnimSprite
{
	...
	public :
        ...
        int  Type;			//  type de l'animation  1 ou 2
