...
void TraceErrorDD(HRESULT hErr,int Gravite)    // Gestion des erreurs de DirectDraw
{
    ...
    {
    	// DirectDrawCreate
	case DDERR_DIRECTDRAWALREADYCREATED : Erreur="Un objet DirectDraw a deja ete cree pour ce process"; break;
	case DDERR_GENERIC                  : Erreur="Erreur inconnue due a une condition indefinie"; break;
	case DDERR_INVALIDDIRECTDRAWGUID    : Erreur="Le GUID passe a DirectDrawCreate() n''est pas un driver directdraw certifie"; break;
	case DDERR_INVALIDPARAMS            : Erreur="Un ou plusieurs parametres passes a cette fonction est incorrect"; break;
	case DDERR_NODIRECTDRAWHW           : Erreur="Le hardware ne supporte pas Directdraw"; break;
	case DDERR_OUTOFMEMORY              : Erreur="Directdraw n'a pas assez de memoire pour accomplir l''operation"; break;

    // Blit
	case DDERR_INVALIDCLIPLIST          :   Erreur="Erreur lors d''un blit()"; break;
	case DDERR_INVALIDOBJECT            :   Erreur="Erreur lors d''un blit()"; break;
	case DDERR_INVALIDRECT              :   Erreur="Erreur lors d''un blit()"; break;
	case DDERR_NOALPHAHW                :   Erreur="Erreur lors d''un blit()"; break;
	case DDERR_NOBLTHW                  :   Erreur="Erreur lors d''un blit()"; break;
	case DDERR_NOCLIPLIST               :   Erreur="Erreur lors d''un blit()"; break;
	case DDERR_NODDROPSHW               :   Erreur="Erreur lors d''un blit()"; break;
	case DDERR_NOMIRRORHW               :   Erreur="Erreur lors d''un blit()"; break;
	case DDERR_NORASTEROPHW             :   Erreur="Erreur lors d''un blit()"; break;
	case DDERR_NOROTATIONHW             :   Erreur="Erreur lors d''un blit()"; break;
	case DDERR_NOSTRETCHHW              :   Erreur="Erreur lors d''un blit()"; break;
	case DDERR_NOZBUFFERHW              :   Erreur="Erreur lors d''un blit()"; break;
	case DDERR_SURFACEBUSY              :   Erreur="Erreur lors d''un blit()"; break;
	case DDERR_SURFACELOST              :   Erreur="Erreur lors d''un blit()"; break;
	case DDERR_UNSUPPORTED              :   Erreur="Erreur lors d''un blit()"; break;
	case DDERR_WASSTILLDRAWING          :   Erreur="Erreur lors d''un blit()"; break;
