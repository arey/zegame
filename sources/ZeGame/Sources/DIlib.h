...
#define JOYSTICK_RANGE_MAX_X	 1000
#define JOYSTICK_RANGE_MIN_X	-1000
#define JOYSTICK_RANGE_MAX_Y	 1000
#define JOYSTICK_RANGE_MIN_Y	-1000
#define JOYSTICK_DEADZONE_X		 3000	// 30%
#define JOYSTICK_DEADZONE_Y		 3000	// 30%
#define JOYSTICK_ANALOGIC_RATIO		4	// utilise pour determiner si un joy est analogique (Range/Granularity>JOYSTICK_ANALOGIC_RATIO)

#define JOYSTICK_WALK_MIN		  300
#define JOYSTICK_RUN_MIN		  950
...
extern BYTE Key_ENTER, Key_PLUS, Key_MOINS, Key_F1, Key_F2, Key_F3, Key_F4, Key_F5, Key_F6, Key_F7,
            Key_F8, Key_F12, Key_GRAVE, Key_PAUSE;
...
class TDirectInput
{
    ...
    private:
		...
		bool bForceFeedback;					// Est-ce un joy a retour de force ?
		...
		int iGranularityX, iGranularityY;		// Granularite des 2 axes
		bool bAnalogic;							// Indique si on a affaire a un joy analogique (computed d'apres la granularite)
		int iAnalogicPercent;					// % de la vitesse
    ...
    public:
		...
		//--- Fonction inline ---
		inline LPDIRECTINPUTDEVICE2 getJoystickDevice() { return pDIJoypad; }
		inline bool isForceFeedback() { return bForceFeedback; }
		inline int getAnalogicPercent() { return iAnalogicPercent; }
		inline bool isAnalogic() { return bAnalogic; }
};
