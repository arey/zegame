...
#include "DDLib.h"			// Accés à toutes les fonctions de la libraire graphique sous DirectDraw
...
{	// Prépare le clipping
	...
	// Change depuis que je tiens compte du mode 16 bits 5:5:5
	const int RMask = 0xF800;	// 1111100000000000
	const int BMask = 0x001F;	// 0000000000011111
	//const int VMask = 0x07E0;	// 0000011111100000
	DWORD VMask = ((TPixelFormatNonIndexedColor*) DS->pixelFormat)->dwGreenBitMask;

	// WORD TRANSPARENCECOLOR16 = (WORD) RGBto16((unsigned long) Sprite->cfRGB);
	WORD TRANSPARENCECOLOR16 = (WORD) DS->RGB24to16((DWORD) Sprite->cfRGB);
