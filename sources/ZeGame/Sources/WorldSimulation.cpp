...
const double sWorldModel::SOUND_DEFAULTMINDISTANCE = 1;		// 1 metre
const double sWorldModel::SOUND_DEFAULTMAXDISTANCE = 200;	// 200 metres
const int	 sWorldModel::SOUND_DEFAULTDBDECREASE = -300;	// -6 dB
