...
//------------------------------------------------------------------------ define
#define ZEGAME_KEY				TEXT("Software\\ZeGame")
...
extern const char cPathWorld[];			// - scripts scenaritiques et parametres du jeu
extern const char cPathSettings[];		// - parametres des objets du jeu
...
extern const char cIniSoundFiles[];				// Liste des bruitages du jeu
...
extern bool g_bPlayOnline;				  // Vrai lorsque le joueur souhaite se connecter a une session multi-jouers via Internet
extern AnsiString g_sPlayerName;		  // Pseudo du joueur (utilise lors d'une partie online)

// -------------------------------------------- Params lies aux registres windows
extern HKEY g_hZegameRegKey;
