...
const char cPathSounds[]	 = "Sound\\";	// - les sons au format .wav
const char cPathMuzik[]		 = "Muzik\\";	// - les musiques au format .wav
const char cPathWorld[]		 = "World\\";	// - scripts scenaritiques et parametres du jeu
const char cPathSettings[]	 = "settings\\";// - parametres des objets du jeu
...
// fichier contenant les n°ID des differents bruitages
const AnsiString cIDSoundEffectFilename = "Sound\\SoundEffect.id";
...
const char cIniSoundFiles[] = "Sound\\SoundFiles.ini";	// Liste des bruitages du jeu
...
std::IDMap *IDSoundEffect = NULL;   // Map des ID des bruitages du jeu
...
bool g_bPlayOnline;				   // Vrai lorsque le joueur souhaite se connecter a une session multi-jouers via Internet
AnsiString g_sPlayerName;		   // Pseudo du joueur (utilise lors d'une partie online)

// -------------------------------------------- Params lies aux registres windows
HKEY g_hZegameRegKey;
